...
rm .gitignore
rm "vendors/composer/autoload_static.php" # Presence of this file breaks wpengine syntax checks, so we must remove it. See https://github.com/composer/composer/issues/5316
